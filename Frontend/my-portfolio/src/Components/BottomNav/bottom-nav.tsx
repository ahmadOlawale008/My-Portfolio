...
const BottomNav = () => {
    return (
        <div className='fixed bottom-11 z-[100000] left-[40%]'>
            <div className="menu inline-flex gap-x-1 dark:bg-zinc-600 bg-zinc-200 rounded-md overflow-auto">
                ...
                <div className="menu-item dark:bg-[#71fe6a] dark:text-black  dark:hover:bg-[#468b43] hover:bg-[#318737] bg-[#2baf34] text-white p-2 rounded-md">
