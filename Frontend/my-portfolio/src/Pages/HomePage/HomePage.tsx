...
const HomePage = () => {
  ...
  return (
    <div className={`dark:bg-primary w-full  bg-slate-100 py-9`}>
      ...
      <div onClick={()=>{
        window.scrollTo(0, 0);
        setScrollPosition(0)
      }} className={`${scrollPosition > 10 ? "fixed" : "hidden" } none z-[100] bg-slate-600/30 cursor-pointer dark:bg-slate-500/40 backdrop-blur-md rounded-full p-3 bottom-10 right-16`}>
