...
const AboutMe = () => {
    ...
    const { scrollYProgress, scrollY } = useScroll({ target: megaCardref, })
    const translateZ = useTransform(scrollY, [0, 600], [200, 0]);
    const x = useTransform(scrollY, [0, 600], [200, 0])
    const opacity = useTransform(scrollY, [0, 1], [0, 1])
    return (
        <motion.div ref={megaCardref} className='z-[1] min-h-[100vh] container mx-auto dark:text-white py-12 text-black h-full relative'>
            ...
            <div className='grid space-x-5  grid-cols-2 mt-8'>
                ...
                <motion.div
                    ...
                    style={{ opacity: opacity, translateZ }}
